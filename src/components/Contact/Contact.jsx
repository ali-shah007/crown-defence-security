...
import './Contact.css';
import contactbg from '../../assets/contact.jpg'; // Ensure you have a background image in your assets

function Contact() {
  return (
    <div
      className="contact-container bg-cover bg-center relative"
      style={{ backgroundImage: `url(${contactbg})` }}
    >
      <div className="absolute inset-0 bg-gray-900 opacity-75"></div>
      
      <div className="relative flex flex-col items-center text-white p-8 mt-10">
        {/* <h1 className="contact-title text-4xl md:text-5xl font-bold mb-4">Contact Us</h1> */}
        ...
        <form className="contact-form bg-gray-800 p-8 rounded-lg w-full max-w-lg">
